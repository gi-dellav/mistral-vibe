...
from glider.acp.utils import ToolOption
from glider.core.types import FunctionCall, ToolCall
...
def _create_glider_home_dir(tmp_path: Path, *sections: dict[str, Any]) -> Path:
