...
from glider.cli.update_notifier.adapters.pypi_update_gateway import PyPIUpdateGateway
from glider.cli.update_notifier.ports.update_gateway import (
    Update,
    UpdateGatewayCause,
    UpdateGatewayError,
)
...
async def test_retrieves_nothing_when_no_versions_are_available() -> None:
    ...
    async with httpx.AsyncClient(transport=transport, base_url=PYPI_API_URL) as client:
        gateway = PyPIUpdateGateway(project_name="glider-code", client=client)
...
async def test_retrieves_the_latest_non_yanked_version() -> None:
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        assert request.url.path == "/simple/glider-code/"
        return httpx.Response(
            ...
            json={
                ...
                "files": [
                    {
                        "filename": "mistral_glider-1.0.0-py3-none-any.whl",
                        "yanked": False,
                    },
                    {"filename": "mistral_glider-1.0.1-py3-none-any.whl", "yanked": True},
                    {
                        "filename": "mistral_glider-1.0.2-py3-none-any.whl",
                        "yanked": False,
                    },
                ],
            },
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        return httpx.Response(
            ...
            json={
                "versions": ["1.0.0"],
                "files": [
                    {"filename": "mistral_glider-1.0.0-py3-none-any.whl", "yanked": True}
                ],
            },
        )
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        return httpx.Response(
            ...
            json={
                ...
                "files": [
                    {
                        "filename": "mistral_glider-1.0.10-py3-none-any.whl",
                        "yanked": False,
                    }
                ],
            },
