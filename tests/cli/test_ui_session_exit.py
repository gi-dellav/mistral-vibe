...
from glider.core.types import AgentStats
...
def test_print_session_resume_message_prints_resume_commands_and_usage(
    ...
    assert capsys.readouterr().out == (
        ...
        "\n"
        "To continue this session, run: glider --continue\n"
        "Or: glider --resume 12345678-1234-1234-1234-123456789abc\n"
    )
