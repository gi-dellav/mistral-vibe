...
from glider.cli.textual_ui.app import StartupOptions, run_textual_ui
...
from glider.core.programmatic import run_programmatic
from glider.core.session.session_loader import SessionLoader
from glider.core.tracing import setup_tracing
from glider.core.types import EntrypointMetadata, LLMMessage, OutputFormat, Role
from glider.core.utils import ConversationLimitException
...
def load_config_or_exit() -> GliderConfig:
    try:
        return GliderConfig.load()
...
def load_session(
    args: argparse.Namespace, config: GliderConfig
