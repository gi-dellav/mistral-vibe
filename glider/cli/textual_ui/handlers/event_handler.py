...
from glider.core.tools.ui import ToolUIDataAdapter
...
from glider.core.utils import TaggedText

if TYPE_CHECKING:
    from glider.cli.textual_ui.widgets.loading import LoadingWidget
