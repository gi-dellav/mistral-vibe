...
from glider.cli.textual_ui.widgets.banner.petit_chat import PetitChat
...
from glider.core.tools.mcp.registry import MCPRegistry
        ...
        with Horizontal(id="banner-container"):
            ...
            with Vertical(id="banner-info"):
                with Horizontal(classes="banner-line"):
                    yield NoMarkupStatic("Glider for Mistral", id="banner-brand")
