...
from glider.core.config.harness_files import init_harness_files_manager
from glider.core.trusted_folders import has_trustable_content, trusted_folders_manager
from glider.setup.trusted_folders.trust_folder_dialog import (
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the Glider for Mistral interactive CLI")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        "or custom from ~/.glider/agents/NAME.toml)",
    )
...
def main() -> None:
    ...
    from glider.cli.cli import run_cli
