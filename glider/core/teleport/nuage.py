...
class GliderAgent(BaseModel):
    polymorphic_type: str = "glider_agent"
    name: str = "glider-agent"
    glider_config: dict[str, Any] | None = None
    session: TeleportSession | None = None


class WorkflowConfig(BaseModel):
    agent: GliderAgent = Field(default_factory=GliderAgent)
