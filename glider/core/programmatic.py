...
from glider.core.output_formatters import create_formatter
...
_DEFAULT_CLIENT_METADATA = ClientMetadata(name="glider_programmatic", version=__version__)
    ...
    async def _async_run() -> str | None:
        try:
            ...
            if teleport and config.nuage_enabled:
                gen = agent_loop.teleport_to_glider_nuage(prompt or None)
