...
from glider.core.types import BaseEvent, ToolResultEvent

CANCELLATION_TAG = "user_cancellation"
TOOL_ERROR_TAG = "tool_error"
GLIDER_STOP_EVENT_TAG = "glider_stop_event"
GLIDER_WARNING_TAG = "glider_warning"

KNOWN_TAGS = [CANCELLATION_TAG, TOOL_ERROR_TAG, GLIDER_STOP_EVENT_TAG, GLIDER_WARNING_TAG]
