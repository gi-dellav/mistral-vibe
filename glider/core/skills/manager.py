...
from glider.core.skills.models import SkillInfo, SkillMetadata
from glider.core.skills.parser import SkillParseError, parse_frontmatter
...
class SkillManager:
    def __init__(self, config_getter: Callable[[], GliderConfig]) -> None:
    ...
    @staticmethod
    def _compute_search_paths(config: GliderConfig) -> list[Path]:
        paths: list[Path] = []
