...
from glider.core.autocompletion.file_indexer.ignore_rules import WALK_SKIP_DIR_NAMES
...
def _collect_config_dirs_at(
    ...
    """Check a single directory for .glider/ and .agents/ config subdirs."""
...
def walk_local_config_dirs_all(
    ...
    """Discover .glider/ and .agents/ config directories under *root*.
...
def has_config_dirs_nearby(
    ...
    """Quick check for .glider/ or .agents/ config dirs in the near subtree.
