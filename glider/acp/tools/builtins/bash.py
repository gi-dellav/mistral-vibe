...
from glider.acp.tools.base import AcpToolState, BaseAcpTool
from glider.core.logger import logger
from glider.core.tools.base import BaseToolState, InvokeContext, ToolError
from glider.core.tools.builtins.bash import Bash as CoreBashTool, BashArgs, BashResult
from glider.core.types import ToolCallEvent, ToolResultEvent, ToolStreamEvent
...
class Bash(CoreBashTool, BaseAcpTool[AcpBashState]):
    prompt_path = GLIDER_ROOT / "core" / "tools" / "builtins" / "prompts" / "bash.md"
    state: AcpBashState
